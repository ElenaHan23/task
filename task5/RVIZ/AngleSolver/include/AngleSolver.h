#ifndef __ANGLESOLVER_
#define __ANGLESOLVER_
...
public:
    AngleSolver();
    AngleSolver(RotatedRect rect, float area, float perimeter);
    ...
    friend bool operator!=(const AngleSolver &t1, const AngleSolver &t2);
