...
AngleSolver::AngleSolver(RotatedRect rect, float area, float perimeter)
{
...
float AngleSolver::get_height()
{
    return this->height;
}
float AngleSolver::get_width()
{
    return this->width;
}

float AngleSolver::get_angle()
{
    return this->angle;
}

float AngleSolver::get_area()
{
    return this->area;
}

void AngleSolver::set_Area(float area)
{
    this->area = area;
}

void AngleSolver::set_angle(float angle)
{
    this->angle = angle;
}

Point2f AngleSolver::get_center()
{
    return this->center;
}

void AngleSolver::set_center(float x, float y)
{
    this->center.x = x;
    this->center.y = y;
}

bool operator!=(const AngleSolver &t1, const AngleSolver &t2)
{
